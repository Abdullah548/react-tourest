...
<div className="container-xxl py-5">
      <div className="container">
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6 fadeInUp" data-wow-delay="0.1s">
            <h5>Get In Touch</h5>
          ...
          {/* Google Maps Embed */}
          <div className="col-lg-4 col-md-6 fadeInUp" data-wow-delay="0.3s">
            <iframe
          ...
          {/* Contact Form */}
          <div className="col-lg-4 col-md-12 fadeInUp" data-wow-delay="0.5s">
            <form>
